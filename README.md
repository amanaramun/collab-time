...
<ol>
<li>hit `ctrl+~` to bring up the terminal</li>
...
<li>Git bash</li>
<ol>
<ls> In the directory you made, right click,right click, `more options`, `open git bash here` (i dont know how to use the gui)
</ol>
</ol>
...
<ol>
<li> type in `git config --user.name "your name" </li>
<li> type in `git config --user.email "your email" </li>
</ol>
<li> type in `git config --user.name "your name" </li>